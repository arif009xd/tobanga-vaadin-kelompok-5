...
@PageTitle("Product")
@Route(value = "product/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@Uses(Icon.class)
public class ProductView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "product/%s/edit";
    ...
    public ProductView(SamplePersonService samplePersonService) {
